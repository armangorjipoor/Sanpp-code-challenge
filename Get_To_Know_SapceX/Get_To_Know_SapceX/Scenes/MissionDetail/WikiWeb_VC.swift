...
class WikiWeb_VC: UIViewController, UIViewControllerRestoration {
...
//    }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let url = url//URL(string: "https://www.apeth.com/RubyFrontierDocs/default.html")!
...
extension WikiWeb_VC : WKNavigationDelegate {
